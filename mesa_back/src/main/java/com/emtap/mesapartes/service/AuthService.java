package com.emtap.mesapartes.service;

import com.emtap.mesapartes.dto.JwtResponse;
import com.emtap.mesapartes.dto.LoginRequest;
import com.emtap.mesapartes.dto.RegisterRequest;
import com.emtap.mesapartes.dto.UserResponse;
import com.emtap.mesapartes.entity.Role;
import com.emtap.mesapartes.entity.User;
import com.emtap.mesapartes.exception.InvalidCredentialsException;
import com.emtap.mesapartes.exception.UserAlreadyExistsException;
import com.emtap.mesapartes.repository.RoleRepository;
import com.emtap.mesapartes.repository.UserRepository;
...
public class AuthService {
    ...
    @Transactional(readOnly = true)
    public JwtResponse generarToken() {
        log.info("Intento de generar token}");
        ...
        try {
            ...
            log.warn("generar token fallido para usuario: {}");
            throw new InvalidCredentialsException("Credenciales inválidas");
        }
    }
