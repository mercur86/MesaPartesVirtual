...
import com.emtap.mesapartes.filter.JwtAuthenticationFilter;
 ...
 * - @EnableMethodSecurity: Permite autorización a nivel de método
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList(
                ...
                // *** PRODUCCIÓN: Agrega aquí el dominio exacto de tu frontend ***
                // Ejemplo: "https://miapp.epsgrau.gob.pe",
                // Ejemplo: "http://192.168.1.50:4200",
                "*" // TEMPORAL: permite todos (quitar en producción final)
        ));
     ...
     *         - Configurable en cuanto a costo computacional (por defecto: 10
     *         rounds)
     */
    @Bean
 ...
 * - JwtAuthenticationFilter se ejecuta ANTES que
